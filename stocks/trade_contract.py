...
class TradeContract:
    """
    Contrato de trade para stocks (sem overnight).
    """

    timeframe_sec: int = 60
    entry_label_windows_minutes: Tuple[int, ...] = (30,)
    exit_ema_span: int = 15
    ...
    # Se o exit cair depois de um gap, zera o label
    forbid_exit_on_gap: bool = True
    gap_hours_forbidden: float = 2.0
