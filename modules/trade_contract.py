...
class TradeContract:
    ...
    # Ajuste para gerar labels "menos exigentes" (mais amostras positivas):
    # - TP menor e timeout maior => mais eventos de TP dentro do horizonte => entry_label menos raro
    # - SL menor mantém simetria de risco, mas evita exigir 5% para considerar trade "bom"
    # Mais conservador: exige alvos maiores e menos tempo para considerar entry=1.
    ...
    # só rotula entry=1 se o trade atingir TP sem cair mais que este limite antes.
    # Isso força exemplos onde a entrada acontece muito perto do fundo (ou após estabilização).
