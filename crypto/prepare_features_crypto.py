...
def main() -> None:
    ...
    os.environ.setdefault("PF_ENTRY_WEIGHT_MODE", "future_consistency_dir")
    os.environ.setdefault("PF_ENTRY_WEIGHT_PCT_POWER", "1.35")
    os.environ.setdefault("PF_ENTRY_WEIGHT_FUTURE_WINDOW_MIN", "60")
    os.environ.setdefault("PF_ENTRY_WEIGHT_FUTURE_DD_PENALTY", "1.20")
    os.environ.setdefault("PF_ENTRY_WEIGHT_FUTURE_AVG_SOFTCAP", "0.015")
    os.environ.setdefault("PF_ENTRY_WEIGHT_FUTURE_END_SOFTCAP", "0.020")
    os.environ.setdefault("PF_ENTRY_WEIGHT_FUTURE_EARLY_AVG_SOFTCAP", "0.008")
    os.environ.setdefault("PF_ENTRY_WEIGHT_FUTURE_END_GAIN", "0.35")
    os.environ.setdefault("PF_ENTRY_WEIGHT_FUTURE_EARLY_GAIN", "1.00")
    os.environ.setdefault("PF_ENTRY_WEIGHT_FUTURE_EARLY_DD_PENALTY", "1.10")
    os.environ.setdefault("PF_ENTRY_WEIGHT_FUTURE_EFF_GAIN", "0.0200")
    os.environ.setdefault("PF_ENTRY_WEIGHT_FUTURE_POS_FRAC_GAIN", "0.0150")
    os.environ.setdefault("PF_ENTRY_WEIGHT_FUTURE_POS_SCALE", "1.70")
    os.environ.setdefault("PF_ENTRY_WEIGHT_FUTURE_NEG_SCALE", "0.70")
    os.environ.setdefault("PF_ENTRY_WEIGHT_MAX", "20.0")
